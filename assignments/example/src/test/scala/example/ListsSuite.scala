...
class ListsSuite extends FunSuite {
  ...
  test("sum of negative and postive numbers") {
    assert(sum(List(4,-3, 5, -6)) === 0)
    assert( sum(List(-1, -4, -6, -7)) === -18 )
  }
  test("sum of zeros and negatie and positive") { 
    assert( sum( List(4,0,-3)) === 1)
  }
  test("sum of empty list") {
    assert(sum(List()) === 0)
  }
  test("sum of 1 element list") {
    assert(sum(List(5)) === 5)
  }
  test("sum of repeated elements") {
    assert(sum(List(1,1,-4,-4, 2,2)) === -2 )
  }
  ...
  test("max of negative and postive numbers") {
    assert(max(List(4,-3, 5, -6)) === 5)
    assert( max(List(-1, -4, -6, -7)) === -1 )
  }
  test("max of zeros and negatie and positive") { 
    assert( max( List(4,0,-3)) === 4)
  }
  ...
  test("max of 1 element list") {
    assert(max(List(5)) === 5)
  }
  test("max of repeated elements") {
    assert(max(List(1,1,-4,-4, 2,2)) === 2 )
  }
}
